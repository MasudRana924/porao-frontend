...
import { fetchTeacherEnrollment, updateEnrollmentStatus } from "../../../../redux/reducers/enrollment/teacherBookSlice";
...
const TutorEnrollment = () => {
  ...
  const { tutorEnrollments } = useSelector((state) => state.enrollment);
  useEffect(() => {
...
console.log(status);
dispatch(updateEnrollmentStatus({token,status,enrollmentId}))
  }
