...
const Pricing = () => {
    return (
        <div className="bg-black mt-8 lg:mt-52">
            <div className="container px-6 py-8 mx-auto">
                <h1 className="text-4xl font-semibold text-center text-white capitalize lg:text-3xl dark:text-white">Tutor Pricing Plan</h1>
                <div className="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
                    <div className="bg-gray-800 border-gray-800 flex items-center justify-between px-8 py-4 border cursor-pointer rounded-xl dark:border-gray-700">
                        <div className="flex flex-col items-center space-y-1">
                            ...
                            <h2 className="text-lg font-medium text-white sm:text-xl dark:text-gray-200">Basic</h2>
                        </div>
                        <h2 className="text-2xl font-semibold text-white sm:text-3xl dark:text-gray-300">Free</h2>
                    </div>
                    <div className="bg-gray-900 flex items-center justify-between px-8 py-4 border border-gray-900 cursor-pointer rounded-xl">
                        <div className="flex flex-col items-center space-y-1">
                    ...
                    <div className="bg-gray-800 border-gray-800  flex items-center justify-between px-8 py-4 border cursor-pointer rounded-xl dark:border-gray-700">
                        <div className="flex flex-col items-center space-y-1">
                            ...
                            <h2 className="text-lg font-medium text-white sm:text-xl dark:text-gray-200">Pro</h2>
                        </div>
                        <div className="flex flex-col items-center space-y-1">
                            <div className="px-2 text-xs text-blue-500 bg-gray-100 rounded-full dark:text-blue-400 sm:px-4 sm:py-1 dark:bg-gray-700 ">
                                Save 20%
