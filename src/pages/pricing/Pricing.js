    ...
    return (
        <div className="bg-black mt-8 lg:mt-52">
            <div className="container px-6 py-8 mx-auto">
                <h1 className="text-4xl font-semibold text-center text-white capitalize lg:text-3xl dark:text-white font-mono">Tutor Pricing Plan</h1>
                <div className="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
                    ...
                    <div className="bg-gray-900 flex items-center justify-between px-8 py-4 border border-gray-900 cursor-pointer rounded-xl">
                        <div className="flex flex-col items-center space-y-1">
                            ...
                            <h2 className="text-lg font-medium text-gray-700 sm:text-xl dark:text-gray-200 font-mono">Standard</h2>
                        </div>
                        <div className="flex flex-col items-center space-y-1">
